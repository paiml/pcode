...
fn generate_token_table() {
    ...
    let patterns = vec![
        ...
        ("fn", 1), ("let", 1), ("mut", 1), ("const", 1), ("struct", 1),
        ("impl", 1), ("pub", 1), ("use", 1), ("mod", 1), ("match", 1),
        ("if", 1), ("else", 1), ("for", 1), ("while", 1), ("loop", 1),
        ("return", 1), ("break", 1), ("continue", 1), ("async", 1), ("await", 1),
        ("self", 1), ("Self", 1), ("super", 1), ("crate", 1),
        
        // Common variable names
        ("i", 1), ("j", 1), ("k", 1), ("x", 1), ("y", 1), ("z", 1),
        ("result", 1), ("error", 1), ("value", 1), ("data", 1),
        ("input", 1), ("output", 1), ("index", 1), ("count", 1),
        ("size", 1), ("length", 1), ("buffer", 1), ("stream", 1),
        ("file", 1), ("path", 1), ("name", 1), ("type", 1),
        
        // Common types
        ("String", 1), ("Vec", 1), ("HashMap", 2), ("Result", 1),
        ("Option", 1), ("Box", 1), ("Arc", 1), ("Mutex", 1),
        
        // Common function calls
        ("println!", 2), ("format!", 2), ("vec!", 1), ("unwrap", 1),
        ("expect", 1), ("clone", 1), ("to_string", 2), ("as_str", 2),
        ("len", 1), ("is_empty", 2), ("push", 1), ("pop", 1),
        ...
        ("the", 1), ("of", 1), ("to", 1), ("and", 1), ("a", 1),
        ("in", 1), ("is", 1), ("it", 1), ("for", 1), ("with", 1),
        ("as", 1), ("on", 1), ("be", 1), ("at", 1), ("by", 1),
        ("from", 1), ("that", 1), ("this", 1), ("have", 1), ("not", 1),
    ];
    ...
    for (pattern, token_count) in patterns {
        ...
        let hash = pattern.bytes().fold(0u64, |acc, b| {
