...
impl StreamHandle {
    pub fn new(id: u64, buffer_size: usize) -> (Self, mpsc::Receiver<StreamRequest>, mpsc::Sender<StreamResponse>) {
...
impl StreamManager {
    ...
    /// Create a new stream
    pub async fn create_stream(&self, buffer_size: usize) -> Result<(u64, StreamHandle, mpsc::Receiver<StreamRequest>, mpsc::Sender<StreamResponse>), McpError> {
...
mod tests {
    ...
    async fn test_echo_stream_tool() {
        ...
        // Create input stream
        let requests = vec![
            StreamRequest { id: 1, sequence: 0, data: Vec::from("hello"), is_last: false },
            StreamRequest { id: 1, sequence: 1, data: Vec::from("world"), is_last: true },
        ];
