...
impl ProtocolHandlerV2 {
    ...
    pub fn encode_message(&self, message: &MessageV2) -> Result<Vec<u8>, Box<dyn std::error::Error>> {
    ...
    pub fn create_stream_init(
        ...
        MessageV2 {
            id,
            message_type: MessageType::StreamInit { method, params, mode },
            correlation_id: None,
        }
    }
    ...
    pub fn create_stream_close(&self, id: u64, stream_id: u64, reason: Option<String>) -> MessageV2 {
        MessageV2 {
            id,
